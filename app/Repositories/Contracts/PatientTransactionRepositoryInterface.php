...
/**
 * Read-only access to hospital (SQL Server) patient transactions — one row
 * per patient encounter (psPatRegisters).
 ...
 */
interface PatientTransactionRepositoryInterface
{
    ...
    /**
     * Find transactions by patient name and/or hospital number (name matches can be many, e.g. "Juan"),
