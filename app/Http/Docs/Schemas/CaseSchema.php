...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'admission_type', type: 'string'),
...
#[OA\Schema(
    ...
    required: ['patient_id', 'case_type', 'priority_level', 'admission_type'],
    properties: [
        new OA\Property(property: 'patient_id', type: 'integer'),
        new OA\Property(property: 'assigned_user_id', type: 'integer', nullable: true),
        ...
        new OA\Property(property: 'admission_type', type: 'string', maxLength: 255),
