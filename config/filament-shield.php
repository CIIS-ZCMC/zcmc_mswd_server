...
return [
    ...
    */
    ...
    'permissions' => [
        ...
        'case' => 'pascal',
        'generate' => true,
        // Keep our aggregate catalog keys (patients.view, roles.manage, …)
        // exactly as defined so the API `permission:` middleware keeps matching.
    ...
    */
    ...
    'resources' => [
        ...
        'exclude' => [
            // Gated directly via our permission catalog (users.*, roles.manage),
            // so Shield should not generate resource-scoped permissions for them.
            UserResource::class,
    ...
    */
    ...
    'custom_permissions' => RolesAndPermissionsSeeder::PERMISSIONS,
